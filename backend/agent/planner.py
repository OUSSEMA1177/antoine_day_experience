...
def plan_next(
    ...
    *,
    ...
    if not _filled(slots, "destination") and intent in (Intent.GREETING, Intent.TUNNEL_QUALIFY):
        return Plan(Action.ASK_DESTINATION, "Destination inconnue")
...
def build_action_instruction(plan: Plan, *, agency_name: str | None = None) -> str:
    ...
    instructions = {
        ...
        Action.ASK_ENVIES: "Demander uniquement les envies (culture, aventure, mer, gastronomie…).",
        ...
        Action.PRESENT_RESULTS: (
            ...
            "Numéroter. Pas d'activités inventées. Pas de devis dans ce message."
        ),
        ...
        Action.ESCALATE: "Appeler escalate_to_advisor.",
        Action.USE_TOOLS: "Utiliser les outils appropriés si nécessaire.",
    }
